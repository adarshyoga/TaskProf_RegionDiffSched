...
inputs_ser=[
    ...
    #"../inputs/sequenceB_261 4 261 4000 5 0 16",
    "1 500 in_500K.fluid out.fluid",#"16 5 in_300K.fluid out.fluid",
    "10 20 128 1000000 200000 5000 none output.txt 1",
    "-ns 64 -sm 40000 -nt 1",#"-ns 128 -sm 1000000 -nt 16", 
...
inputs_par=[
    ...
    #"../inputs/sequenceB_261 4 261 4000 5 0 16",
    "16 500 in_500K.fluid out.fluid",#"16 5 in_300K.fluid out.fluid",
    "10 20 128 1000000 200000 5000 none output.txt 16",
    "-ns 64 -sm 40000 -nt 16",#"-ns 128 -sm 1000000 -nt 16", 
            ...
            try:
                ...
                if do_run:
                    ...
                    for filename in files:
                        if filename.startswith("par_for_size_"):
                            ...
                            for line in lines:
                                ...
                                if key in count_map:
                                    ...
                                    val[0] = val[0] + int(line_info[-1])
                                    val[1] = val[1] + 1
                                else:
                                    count_map[key] = [int(line_info[-1]),1]
                    print count_map
                    f = open('par_for_counts.txt', 'w')
                    for key,value in count_map.items():
                        avg = value[0]/value[1]
                        f.write(key + " : " + str(int(avg)) + "\n")
                    f.close()
