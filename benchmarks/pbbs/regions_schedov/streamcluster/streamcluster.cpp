...
float pspeedy(Points *points, float z, long *kcenter)
{
  ...
  /* create center at first point, send it to itself */
  {
    ...
    tbb::parallel_for(tbb::blocked_range<int>(0,points->num, grain_size),c,__FILE__, __LINE__);
  }
  ...
  *kcenter = 1;
...

  {
	...
	tbb::parallel_reduce(tbb::blocked_range<int>(0,points->num,grain_size),c, __FILE__,__LINE__);
      }
    }
	       ...
	       int pid, pthread_barrier_t* barrier )
{
  ...
  if(grain_size==0)
    ...
    tbb::parallel_reduce(tbb::blocked_range<int>(0,points->num, grain_size), h, __FILE__,__LINE__);
    hiz = h.getHiz();
  }
