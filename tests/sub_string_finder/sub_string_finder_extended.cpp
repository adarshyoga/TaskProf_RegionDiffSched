...
int main(int argc, char *argv[]) {
 ...
 parallel_for(blocked_range<size_t>(0, num_elem, 100),SubStringFinder( to_scan, max, pos ), __FILE__, __LINE__ );
 ...
 parallel_for(blocked_range<size_t>(0, num_elem, 100),SubStringFinder( to_scan, max3, pos3 ), __FILE__, __LINE__ );
 }
